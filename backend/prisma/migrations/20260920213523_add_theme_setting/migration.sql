...
INSERT INTO "new_Settings" ("carbsGoal", "e1rmFormula", "exercisePickerMode", "fatGoal", "id", "kcalGoal", "language", "proteinGoal", "showCalendarWidget", "showE1rm", "showNutritionWidget", "showWorkoutWidget", "trainingsPerWeek") SELECT "carbsGoal", "e1rmFormula", "exercisePickerMode", "fatGoal", "id", "kcalGoal", "language", "proteinGoal", "showCalendarWidget", "showE1rm", "showNutritionWidget", "showWorkoutWidget", "trainingsPerWeek" FROM "Settings";
DROP TABLE "Settings";
