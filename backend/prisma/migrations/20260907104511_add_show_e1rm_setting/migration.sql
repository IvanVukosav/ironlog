...
INSERT INTO "new_Settings" ("carbsGoal", "exercisePickerMode", "fatGoal", "id", "kcalGoal", "proteinGoal", "showCalendarWidget", "showNutritionWidget", "showWorkoutWidget", "trainingsPerWeek") SELECT "carbsGoal", "exercisePickerMode", "fatGoal", "id", "kcalGoal", "proteinGoal", "showCalendarWidget", "showNutritionWidget", "showWorkoutWidget", "trainingsPerWeek" FROM "Settings";
DROP TABLE "Settings";
