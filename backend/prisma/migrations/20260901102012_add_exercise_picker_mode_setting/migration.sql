...
INSERT INTO "new_Settings" ("carbsGoal", "fatGoal", "id", "kcalGoal", "proteinGoal", "showCalendarWidget", "showNutritionWidget", "showWorkoutWidget", "trainingsPerWeek") SELECT "carbsGoal", "fatGoal", "id", "kcalGoal", "proteinGoal", "showCalendarWidget", "showNutritionWidget", "showWorkoutWidget", "trainingsPerWeek" FROM "Settings";
DROP TABLE "Settings";
