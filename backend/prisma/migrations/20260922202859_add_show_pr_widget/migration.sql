...
CREATE TABLE "new_Settings" (
    ...
    "showPrWidget" BOOLEAN NOT NULL DEFAULT true,
...
INSERT INTO "new_Settings" ("carbsGoal", "e1rmFormula", "exercisePickerMode", "fatGoal", "id", "kcalGoal", "language", "proteinGoal", "showCalendarWidget", "showE1rm", "showNutritionWidget", "showWorkoutWidget", "template", "theme", "trainingsPerWeek") SELECT "carbsGoal", "e1rmFormula", "exercisePickerMode", "fatGoal", "id", "kcalGoal", "language", "proteinGoal", "showCalendarWidget", "showE1rm", "showNutritionWidget", "showWorkoutWidget", "template", "theme", "trainingsPerWeek" FROM "Settings";
DROP TABLE "Settings";
