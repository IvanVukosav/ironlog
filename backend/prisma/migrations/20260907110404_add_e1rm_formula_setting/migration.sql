...
INSERT INTO "new_Settings" ("carbsGoal", "exercisePickerMode", "fatGoal", "id", "kcalGoal", "proteinGoal", "showCalendarWidget", "showE1rm", "showNutritionWidget", "showWorkoutWidget", "trainingsPerWeek") SELECT "carbsGoal", "exercisePickerMode", "fatGoal", "id", "kcalGoal", "proteinGoal", "showCalendarWidget", "showE1rm", "showNutritionWidget", "showWorkoutWidget", "trainingsPerWeek" FROM "Settings";
DROP TABLE "Settings";
